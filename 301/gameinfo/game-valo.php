...
<div class="container">
    <h2>เกี่ยวกับเกม</h2>
    <p>VALORANT เป็นเกมยิงปืนเชิงกลยุทธ์แบบ 5v5 จาก Riot Games ที่ผสมผสานความแม่นยำและความสามารถพิเศษของแต่ละตัวละคร ผู้เล่นจะต้องวางแผนร่วมกับทีมเพื่อป้องกันหรือโจมตีเป้าหมายในแผนที่ต่างๆ</p>

    <h2>ระบบการเล่น</h2>
    <p>ผู้เล่นเลือกตัวละคร (Agent) แต่ละตัวมีสกิลเฉพาะตัว ระบบเกมเน้นความแม่นยำ การวางแผน และการสื่อสารระหว่างทีม การเล่นจะมีโหมด Competitive และ Casual ให้เลือก</p>

    <h2>คุณสมบัติเด่น</h2>
    <ul>
        <li>เกมยิงปืน 5v5 แบบ Competitive</li>
        <li>ตัวละครแต่ละตัวมีสกิลเฉพาะตัว</li>
        <li>แผนที่หลากหลายพร้อมจุดยุทธศาสตร์</li>
        <li>ระบบ Ranked เพื่อวัดฝีมือ</li>
        <li>รองรับ Cross-Platform ผ่าน Riot Account</li>
    </ul>

    <h2>ดาวน์โหลดเกม</h2>
    <a href="https://playvalorant.com/th-th/" class="button" target="_blank">ไปที่หน้าเว็บไซต์ VALORANT</a>
    <br>
